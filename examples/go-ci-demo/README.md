...
Small Go module for exercising `test-analyzer` against realistic CI-style failures.
...
```bash
uv run test-analyzer -C examples/go-ci-demo go test ./...
```
